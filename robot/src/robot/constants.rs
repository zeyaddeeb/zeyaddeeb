...
pub const HIP_MIN: f32 = -PI * 0.15;
pub const HIP_MAX: f32 = PI * 0.4;
pub const KNEE_MIN: f32 = -PI * 0.7;
pub const KNEE_MAX: f32 = 0.1;
pub const SHOULDER_TORQUE_SCALE: f32 = 25.0;
pub const ELBOW_TORQUE_SCALE: f32 = 12.0;
pub const WRIST_TORQUE_SCALE: f32 = 3.0;
pub const TORSO_TORQUE_SCALE: f32 = 10.0;
pub const HIP_TORQUE_SCALE: f32 = 40.0;
pub const KNEE_TORQUE_SCALE: f32 = 40.0;
pub const ANKLE_TORQUE_SCALE: f32 = 10.0;
